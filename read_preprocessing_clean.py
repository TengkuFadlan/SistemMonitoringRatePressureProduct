...
class PreprocessMonitorWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("ECG Preprocessing (Clean) | CSV File")
    ...
    def _build_ui(self):
        ...
        title = QLabel("Raw vs Clean\nECG Signal")
        title.setObjectName("MainTitle")
        subtitle = QLabel("Bandpass + Notch Filter")
        ...
        self.clean_plot = pg.PlotWidget(title="Bandpass + Notch Filter (Clean Signal)")
    ...
    def _apply_theme(self):
        ...
        bg = "#111827"
        fg = "#cbd5e1"
        for pw in [self.raw_plot, self.clean_plot]:
            pw.setBackground(bg)
...
def main():
    ...
    app.setApplicationName("ECG Preprocessing (Clean)")
    font = QFont("Inter", 10)
    app.setFont(font)
